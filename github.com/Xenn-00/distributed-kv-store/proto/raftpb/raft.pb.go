...
type LogEntry struct {
	...
	Command       []byte                 `protobuf:"bytes,3,opt,name=command,proto3" json:"command,omitempty"` // serialized command KV operation
...
type AppendEntriesResponse struct {
	...
	MatchIndex    uint64                 `protobuf:"varint,3,opt,name=matchIndex,proto3" json:"matchIndex,omitempty"` // for optimization: index of the last entry matched
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_raft_proto_rawDesc = "" +
	...
	"\acommand\x18\x03 \x01(\fR\acommand\"\xda\x01\n" +
	...
	"\x0fInstallSnapshot\x12\x1c.raft.InstallSnapshotRequest\x1a\x1d.raft.InstallSnapshotResponseB6Z4github.com/Xenn-00/distributed-kv-store/proto/raftpbb\x06proto3"
...
var file_proto_raft_proto_depIdxs = []int32{
	...
	5, // 3: raft.Raft.InstallSnapshot:input_type -> raft.InstallSnapshotRequest
	...
	6, // 6: raft.Raft.InstallSnapshot:output_type -> raft.InstallSnapshotResponse
